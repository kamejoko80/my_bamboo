 ...
 *
 */
#define	PMUM_CPCR	(PMUM_BASE+0x0000)	/* 32 bit	Marvell CP/AP Power Control
										 *			Register
										 */
#define	PMUM_CPSR	(PMUM_BASE+0x0004)	/* 32 bit	Marvell CP/AP Power Status
										 *			Register
										 */
...
#define	PMUM_VRCR	(PMUM_BASE+0x0018)	/* 32 bit	VCXO Request Control
										 *			Register
										 */
#define	PMUM_CPRR	(PMUM_BASE+0x0020)	/* 32 bit	Marvell CP/AP Programmable
										 *			Reset Register
										 */
#define	PMUM_CCGR	(PMUM_BASE+0x0024)	/* 32 bit	Marvell CP/AP Clock Gating
										 *			Register
										 */
#define	PMUM_CRSR	(PMUM_BASE+0x0028)	/* 32 bit	Marvell CP/AP Reset Status
										 *			Register
										 */
...
#define	PMUM_DSOC	(PMUM_BASE+0x0100)	/* 32 bit	Debug Signals Output
										 *			Control Register
										 */
#define	PMUM_WDTPCR	(PMUM_BASE+0x0200)	/* 32 bit	WDT (CP Timers) Control
										 *			Register
										 */
#define	PMUM_CMPRX	(PMUM_BASE+0x0400)	/* Marvell CP/AP Module Power Register Start */
#define	PMUM_APCR	(PMUM_BASE+0x1000)	/* 32 bit	Marvell CP/AP Power Control
										 *			Register
										 */
#define	PMUM_APSR	(PMUM_BASE+0x1004)	/* 32 bit	Marvell CP/AP Power Status
										 *			Register
										 */
#define	PMUM_APRR	(PMUM_BASE+0x1020)	/* 32 bit	Marvell CP/AP Programmable
										 *			Reset Register
										 */
#define	PMUM_ACGR	(PMUM_BASE+0x1024)	/* 32 bit	Marvell CP/AP Clock Gating
										 *			Register
										 */
#define	PMUM_ARSR	(PMUM_BASE+0x1028)	/* 32 bit	Marvell CP/AP Reset Status
										 *			Register
										 */
 ...
 *
 */
/*	PMUM_CPCR	0x0000	Marvell CP/AP Power Control Register */
#define	PMUM_CPCR_AXISDD				BIT_31			/* AXISDD */
...
/*	PMUM_CPSR	0x0004	Marvell CP/AP Power Status Register */
...
/*	PMUM_CPRR	0x0020	Marvell CP/AP Programmable Reset Register */
...
/*	PMUM_CCGR	0x0024	Marvell CP/AP Clock Gating Register */
...
#define	PMUM_CWUCRS_BB_VCTCXO_REQ						BIT_30	/* Bb_vctcxo_req */
...
/*	PMUM_WDTPCR	0x0200	WDT (CP Timers) Control Register */
...
/*	PMUM_CMPRx	0x0400	Marvell CP/AP Module Power Register */
...
/*	PMUM_APCR	0x1000	Marvell CP/AP Power Control Register */
#define	PMUM_APCR_AXISDD				BIT_31			/* AXISDD */
...
/*	PMUM_APSR	0x1004	Marvell CP/AP Power Status Register */
...
#define	PMUM_APSR_AP_SLEEP				BIT_25			/* AP_SLEEP */
#define	PMUM_APSR_CP_SLEEP				BIT_24			/* CP_SLEEP */
...
/*	PMUM_APRR	0x1020	Marvell CP/AP Programmable Reset Register */
...
/*	PMUM_ACGR	0x1024	Marvell CP/AP Clock Gating Register */
